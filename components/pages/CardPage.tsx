...
export function CardPage() {
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-green-600" style={{ fontSize: 'var(--text-sm)' }}>
                +12% from last month
              </p>
            </CardContent>
          </Card>
      ...
      <ComponentSection 
        title="Card Without Sections"
        description="Simple card with just content"
      >
        <Card className="max-w-md">
          <CardContent className="pt-6">
            <p>This is a simple card with just content. No header or footer sections.</p>
          </CardContent>
        </Card>
      </ComponentSection>
    </div>
